...
const styles = StyleSheet.create({
  ...
  backBtn: { fontSize: 16, fontWeight: '800', color: theme.colors.sky },
  ...
  sectionTitle: { fontSize: 12, fontWeight: '900', color: '#94A3B8', letterSpacing: 1.2, marginBottom: 12, textTransform: 'uppercase' },
  stepperBox: { padding: 24, backgroundColor: '#FFFFFF', borderRadius: 22, borderWidth: 1, borderColor: '#E2E8F0', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.06, shadowRadius: 18, elevation: 4 },
  ...
  stepLabel: { position: 'absolute', fontSize: 10, fontWeight: '800', color: '#64748B', textAlign: 'center', width: 60 },
  escrowBanner: { marginTop: 16, backgroundColor: '#FFFBEB', borderRadius: 16, padding: 16, borderLeftWidth: 4, borderLeftColor: theme.colors.gold, borderWidth: 1, borderColor: '#FDE68A' },
  escrowText: { fontSize: 14, color: theme.colors.gold },
  deliveryDate: { fontSize: 12, color: '#64748B', marginTop: 4 },
  card: { padding: 22, backgroundColor: '#FFF', borderRadius: 20, borderColor: '#E2E8F0', borderWidth: 1, shadowColor: '#0F172A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.06, shadowRadius: 18, elevation: 4 },
  cardRow: { fontSize: 14, color: theme.colors.ink, marginBottom: 8, fontWeight: '600' },
  cardLabel: { color: '#94A3B8', fontWeight: '800', width: 100 },
  actionGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, padding: 24, marginTop: 12 },
  secondaryBtn: { width: '47%', paddingVertical: 15, borderRadius: 16, borderWidth: 1, borderColor: '#CBD5E1', alignItems: 'center', backgroundColor: '#FFF' },
  secondaryBtnText: { fontSize: 13, fontWeight: '800', color: '#64748B' },
  primaryBtn: { width: '100%', paddingVertical: 18, borderRadius: 16, backgroundColor: theme.colors.green, alignItems: 'center', marginTop: 12, shadowColor: '#16A34A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.18, shadowRadius: 16, elevation: 6 },
