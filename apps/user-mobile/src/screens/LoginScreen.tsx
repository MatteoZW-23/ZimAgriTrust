...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 31, fontWeight: '900', color: theme.colors.ink, marginTop: 24, textAlign: 'center', letterSpacing: -0.4 },
  subTitle: { fontSize: 15, color: theme.colors.gray[600], marginTop: 10, textAlign: 'center', fontWeight: '500', lineHeight: 23, maxWidth: 280 },
  form: {
    marginHorizontal: 18,
    marginTop: -18,
    padding: 24,
  ...
  errorBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.dangerTint, padding: 14, borderRadius: 16, marginBottom: 18, borderWidth: 1, borderColor: '#F5CACA' },
  errorText: { color: theme.colors.red, marginLeft: 8, flex: 1, fontSize: 14, fontWeight: '700' },
  lockoutBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.warningTint, padding: 14, borderRadius: 16, marginBottom: 18, borderWidth: 1, borderColor: '#F0D8A2' },
  lockoutText: { color: '#8C5B00', marginLeft: 8, flex: 1, fontSize: 14, fontWeight: '700' },
  biometricButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: theme.colors.successTint, padding: 16, borderRadius: 18, borderWidth: 1, borderColor: '#CFE8D8', marginBottom: 22 },
  biometricButtonText: { color: theme.colors.green, fontSize: 16, fontWeight: '800', marginLeft: 12 },
  phoneInputRow: { flexDirection: 'row', height: 58, borderRadius: 18, borderWidth: 1, borderColor: theme.colors.gray[200], backgroundColor: '#FFF', overflow: 'hidden', marginBottom: 20, ...theme.shadows.xs },
  countryCode: { width: 88, justifyContent: 'center', alignItems: 'center', borderRightWidth: 1, borderRightColor: theme.colors.gray[300], backgroundColor: theme.colors.gray[100] },
  codeText: { fontWeight: '800', color: theme.colors.ink, fontSize: 16 },
  phoneInput: { flex: 1, paddingHorizontal: 16, fontSize: 16, fontWeight: '500', color: theme.colors.ink },
  label: { fontSize: 12, fontWeight: '800', color: theme.colors.gray[600], marginBottom: 10, letterSpacing: 1, textTransform: 'uppercase' },
  pinInputContainer: { flexDirection: 'row', alignItems: 'center', height: 58, borderRadius: 18, backgroundColor: '#FFF', borderWidth: 1, borderColor: theme.colors.gray[200], marginBottom: 12, ...theme.shadows.xs },
  pinInput: { flex: 1, paddingHorizontal: 16, fontSize: 16, fontWeight: '500', color: theme.colors.ink },
  eyeButton: { padding: 16 },
  attemptsText: { fontSize: 12, color: theme.colors.red, marginBottom: 16, textAlign: 'center', fontWeight: '700' },
  primaryBtn: { backgroundColor: theme.colors.green, paddingVertical: 18, borderRadius: 20, alignItems: 'center', ...theme.shadows.md },
  disabledBtn: { backgroundColor: theme.colors.gray[400], shadowOpacity: 0 },
  primaryBtnText: { color: '#FFF', fontSize: 16, fontWeight: '900', letterSpacing: 0.3 },
  registerBtn: { marginTop: 12, paddingVertical: 16, borderRadius: 20, alignItems: 'center', borderWidth: 1, borderColor: '#D7E6FF', backgroundColor: theme.colors.mist },
  registerBtnText: { color: theme.colors.sky, fontSize: 15, fontWeight: '900' },
  guestBtn: { marginTop: 12, paddingVertical: 14, borderRadius: 18, alignItems: 'center', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: theme.colors.gray[200] },
  guestBtnText: { color: '#475569', fontSize: 14, fontWeight: '800' },
  forgotBtn: { marginTop: 16, alignItems: 'center' },
  forgotBtnText: { color: theme.colors.green, fontSize: 13, fontWeight: '800' },
  otpRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24 },
  otpBox: { width: 48, height: 56, borderRadius: 16, borderWidth: 1, borderColor: theme.colors.gray[200], justifyContent: 'center', alignItems: 'center', backgroundColor: '#FFF' },
  otpInput: { fontSize: 24, fontWeight: '800', textAlign: 'center' },
  timerText: { textAlign: 'center', color: theme.colors.gray[600], marginBottom: 32, fontWeight: '600', fontSize: 14 },
  avatarPlaceholder: { width: 110, height: 110, borderRadius: 32, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: theme.colors.gray[200], ...theme.shadows.sm },
  input: { height: 56, borderRadius: 18, backgroundColor: '#FFF', paddingHorizontal: 18, fontSize: 16, fontWeight: '500', borderWidth: 1, borderColor: theme.colors.gray[200], color: theme.colors.ink, ...theme.shadows.xs },
  chipRow: { flexDirection: 'row', gap: 10, marginTop: 12, marginBottom: 24 },
  chip: { paddingHorizontal: 20, paddingVertical: 12, borderRadius: 16, backgroundColor: theme.colors.gray[100], borderWidth: 1, borderColor: theme.colors.gray[200] }
});
