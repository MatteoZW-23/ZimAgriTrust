...
const styles = StyleSheet.create({
  ...
  backCircle: { width: 42, height: 42, borderRadius: 21, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#E2E8F0' },
  headerTitle: { fontSize: 19, fontWeight: '900', color: theme.colors.ink },
  section: { marginTop: 26, paddingHorizontal: 24 },
  sectionTitle: { fontSize: 12, fontWeight: '900', color: '#94A3B8', letterSpacing: 1.2, marginBottom: 16, textTransform: 'uppercase' },
  balanceCard: { padding: 40, backgroundColor: theme.colors.ink, borderRadius: 30, alignItems: 'center', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.18, shadowRadius: 22, elevation: 8 },
  ...
  balanceTag: { color: '#94A3B8', fontSize: 12, fontWeight: '800', marginTop: 8, textTransform: 'uppercase', letterSpacing: 0.6 },
  actionRow: { flexDirection: 'row', gap: 12, marginTop: 32 },
  actionBtn: { flex: 1, paddingVertical: 13, paddingHorizontal: 8, backgroundColor: 'rgba(255, 255, 255, 0.1)', borderRadius: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  actionBtnText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
  depositCard: { marginTop: 14, backgroundColor: '#FFF', borderRadius: 22, padding: 18, borderWidth: 1, borderColor: '#E2E8F0', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.06, shadowRadius: 18, elevation: 4 },
  inputLabel: { color: '#64748b', fontSize: 12, fontWeight: '900', textTransform: 'uppercase', marginBottom: 8 },
  depositInput: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 16, padding: 15, fontSize: 17, fontWeight: '900' },
  depositBtn: { backgroundColor: theme.colors.green, borderRadius: 16, paddingVertical: 15, alignItems: 'center', marginTop: 12, shadowColor: '#16A34A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.18, shadowRadius: 16, elevation: 6 },
  depositBtnText: { color: '#FFF', fontWeight: '900' },
  listCard: { backgroundColor: '#FFFFFF', borderRadius: 24, overflow: 'hidden', borderWidth: 1, borderColor: '#E2E8F0', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.06, shadowRadius: 18, elevation: 4 },
  txItem: { flexDirection: 'row', justifyContent: 'space-between', padding: 20, borderTopWidth: 1, borderTopColor: '#EEF2F7' },
  txLeft: { flex: 1, paddingRight: 12 },
  txDate: { fontSize: 12, fontWeight: '800', color: '#94A3B8' },
  txRef: { fontSize: 15, fontWeight: '800', color: theme.colors.ink, marginTop: 4 },
  txRight: { alignItems: 'flex-end' },
  txAmount: { fontSize: 16, fontWeight: '800', textAlign: 'right' },
  txStatus: { fontSize: 11, fontWeight: '900', textAlign: 'right', marginTop: 4, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  card: { padding: 24, backgroundColor: '#FFF', borderRadius: 24, borderWidth: 1, borderColor: '#E2E8F0', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.06, shadowRadius: 18, elevation: 4 },
  methodRow: { flexDirection: 'row', alignItems: 'center', gap: 16 },
  methodIconBox: { width: 46, height: 46, borderRadius: 23, backgroundColor: '#F0F9FF', justifyContent: 'center', alignItems: 'center' },
  methodTitle: { fontSize: 15, fontWeight: '800', color: theme.colors.ink },
  methodSub: { fontSize: 12, color: theme.colors.green, fontWeight: '700', marginTop: 2 },
  addBtn: { margin: 24, paddingVertical: 15, borderStyle: 'dashed', borderWidth: 2, borderColor: '#CBD5E1', borderRadius: 18, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', backgroundColor: '#FFFFFF' },
  addBtnText: { color: '#64748B', fontWeight: '800', fontSize: 14 },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#EEF2F7' },
  label: { fontSize: 14, fontWeight: '700', color: theme.colors.ink },
  value: { fontSize: 14, fontWeight: '800', color: theme.colors.ink },
  ...
  sortModalContent: { backgroundColor: '#fff', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 24 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 },
  modalTitle: { fontSize: 20, fontWeight: '900', color: '#111827' },
  balanceInfo: { backgroundColor: '#F0FDF4', borderRadius: 16, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#BBF7D0' },
  ...
  modalInput: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 16, padding: 16, fontSize: 17, fontWeight: '900', marginBottom: 16 },
