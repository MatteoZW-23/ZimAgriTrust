...
const styles = StyleSheet.create({
  ...
  routeText: { fontSize: 15, fontWeight: '700', color: theme.colors.ink, flex: 1 },
  routeDivider: { width: 2, height: 16, backgroundColor: '#DCE6F2', marginLeft: 4, marginVertical: 4 },
  routeMeta: { flexDirection: 'row', gap: 8, marginTop: 16, paddingTop: 14, borderTopWidth: 1, borderTopColor: '#EEF2F7' },
  metaChip: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#F8FAFC', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, borderWidth: 1, borderColor: '#E2E8F0' },
  ...
  sectionTitle: { fontSize: 14, fontWeight: '900', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 20 },
  ...
  timelineLine: { width: 2, flex: 1, backgroundColor: '#DCE6F2', marginVertical: 4 },
  timelineContent: { flex: 1, paddingBottom: 16 },
  timelineLabel: { fontSize: 15, fontWeight: '700', color: '#94A3B8' },
  ...
  actionText: { color: '#FFF', fontSize: 16, fontWeight: '800', letterSpacing: 0.5 },
  completeCard: { marginHorizontal: 20, marginTop: 24, backgroundColor: '#E8F5E9', borderRadius: 24, padding: 28, alignItems: 'center' },
  ...
  quickLabel: { fontSize: 13, fontWeight: '800', color: theme.colors.ink },
