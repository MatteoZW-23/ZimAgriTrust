...
const styles = StyleSheet.create({
  ...
  splash: { flex: 1, backgroundColor: theme.colors.dark, justifyContent: 'center', alignItems: 'center' },
  ...
  splashMarket: { fontSize: 18, fontWeight: '700', color: theme.colors.gold, letterSpacing: 1.5, textTransform: 'uppercase', marginTop: 8 },
