...
export default function Features() {
 ...
 return (
 <section className="features-section" id="features"><div className="container"><div className="section-header fade-in"><span className="section-label">Why Choose Us</span><h2>Simple, Safe, and Direct</h2><p>Everything you need to buy or sell crops without the hassle of middlemen.</p></div>
<div className="features-grid">{features.map((f, i) => (
 <div key={i} className="feature-card-premium fade-in"><div className="feature-icon-wrapper">{f.icon}
 </div><h3>{f.title}</h3><p>{f.desc}</p></div>))}
 </div>
<div className="how-it-works-banner fade-in" id="how-it-works"><div className="banner-text-simple"><h2>No Smartphone? No Problem.</h2><p>Dial <strong>*123#</strong> on any mobile phone to buy, sell, or check prices. No internet required.</p><div className="ussd-simple">Works on all networks</div></div></div></div></section>);
}
