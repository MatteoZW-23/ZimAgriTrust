...
const ZimFlag = () => (
  <svg viewBox="0 0 40 24" className="w-8 h-5 rounded shadow-sm">
    <rect width="40" height="8" fill="#009739" />
    <rect y="8" width="40" height="8" fill="#FFD700" />
    <rect y="16" width="40" height="8" fill="#DC143C" />
    <polygon points="0,0 12,12 0,24" fill="#000000" />
    <polygon points="2,0 12,10 2,20" fill="#FFFFFF" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-earth-300 leading-relaxed mb-6">
              Connecting farmers directly with buyers across Zimbabwe. Trade crops safely with secure payments and reliable delivery.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-earth-300 text-sm">PaJunction Mall Shop M3, Harare, Zimbabwe</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-primary-400 flex-shrink-0" />
                <a href="tel:+263717358956" className="text-earth-300 text-sm hover:text-primary-400 transition-colors">
                  +263 71 735 8956
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-primary-400 flex-shrink-0" />
                <a href="mailto:info@zimagritrust.co.zw" className="text-earth-300 text-sm hover:text-primary-400 transition-colors">
                  info@zimagritrust.co.zw
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-earth-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-earth-400 text-sm">
              &copy; {currentYear} ZimAgritrust Limited. All rights reserved.
            </p>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-earth-900">Contact Us</h2>
                <button 
                  onClick={() => setShowContactModal(false)}
              ...
              <div className="space-y-3 mb-6">
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-earth-800">Phone</p>
                    <p className="text-sm text-earth-500">+263 71 735 8956</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-earth-800">Email</p>
                    <p className="text-sm text-earth-500">info@zimagritrust.co.zw</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-earth-800">WhatsApp</p>
                    <p className="text-sm text-earth-500">+263 71 735 8956</p>
                  </div>
                </a>
              </div>
              ...
              <div className="pt-4 border-t border-earth-100">
                <p className="text-xs font-semibold text-earth-400 uppercase tracking-wider mb-2 text-center">Business Hours</p>
                <div className="text-center text-sm text-earth-600 space-y-1">
