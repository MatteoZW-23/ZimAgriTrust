            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  ZimAgriTrust is revolutionizing Zimbabwe’s agricultural
                ...
                <div className="bg-green-50 border-l-4 border-green-700 rounded-r-2xl p-8">
                  <p className="text-2xl font-semibold italic text-green-900 leading-relaxed">
                    “Our goal is to ensure no farmer is left behind in the
                    digital age.”
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  To become Africa’s leading agricultural marketplace platform,
            ...
            <aside className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-green-700 to-green-900 rounded-3xl p-8 text-white">
                ...
                <p className="text-green-100 leading-relaxed mb-8">
                  Join Zimbabwe’s trusted agricultural marketplace and start
