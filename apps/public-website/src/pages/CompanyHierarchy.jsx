  ...
  return (
    <div className="min-h-screen bg-earth-50">
      ...
      <section className="bg-gradient-to-br from-primary-700 to-primary-900 text-white py-16 lg:py-24">
        <div className="container-custom">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Organizational Structure</h1>
            <p className="text-xl text-primary-100">Our leadership and organizational hierarchy</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Executive Leadership</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Meet our C-Suite executives leading the company</p>
          </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center flex-shrink-0">
                    <span className="text-sm font-bold text-primary-700">{exec.code}</span>
                  </div>
                  <div>
                    <h3 className="font-semibold text-earth-900 mb-1">{exec.role}</h3>
                    <p className="text-sm text-earth-500 leading-relaxed">{exec.desc}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Board of Directors</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Independent oversight and strategic guidance</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
            {["Board Chairman", "Independent Director 1", "Independent Director 2", "Independent Director 3", "Independent Director 4"].map((title, index) => (
              <motion.div
                key={title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h3 className="font-medium text-earth-900 text-sm mb-2">{title}</h3>
                <p className="text-xs text-earth-500">{index === 0 ? "Provides strategic guidance" : index === 1 ? "Agri industry expert" : index === 2 ? "Fintech background" : index === 3 ? "Legal & governance expert" : "Supply chain expert"}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Departmental Structure</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Our functional departments and sub-teams</p>
          </div>
            ...
            {departments.map((dept, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-semibold text-earth-900">{dept.name}</h3>
                </div>
                <div className="space-y-2">
                  {dept.subs.map((sub) => (
                    <div key={sub} className="flex items-center gap-2 text-sm text-earth-600">
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Regional Structure</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Our presence across Zimbabwe's provinces</p>
          </div>
            ...
            {regions.map((region, index) => (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-medium text-earth-900 text-sm">{region.name}</h3>
                </div>
                <p className="text-xs text-earth-500">{region.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Reporting Structure</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Clear chain of command and accountability</p>
          </div>
              ...
              {[
                ...
                >
                  <div className="w-16 h-16 rounded-xl bg-primary-100 flex items-center justify-center flex-shrink-0">
                    <span className="text-lg font-bold text-primary-700">{item.level.split(" ")[1]}</span>
                  </div>
                  <div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Committee Structure</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Governance and oversight committees</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              >
                ...
                <h3 className="font-medium text-earth-900 text-sm mb-1">{committee.name}</h3>
                <p className="text-xs text-earth-500">{committee.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
