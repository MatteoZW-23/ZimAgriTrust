  ...
  return (
    <div className="min-h-screen bg-earth-50">
        ...
        <div className="container-custom">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm mb-6">
              ...
              <span className="text-sm font-medium">Driver Opportunity</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Drive with ZimAgritrust</h1>
            <p className="text-xl text-primary-100">Join our logistics network and earn delivering crops across Zimbabwe</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">Why Drive with Us?</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Benefits of joining our driver network</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-sm text-earth-500">{feature.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-earth-900 mb-6">Requirements</h2>
            ...
            >
              <h3 className="text-xl font-semibold text-earth-900 mb-4">Download the Driver App</h3>
              <p className="text-earth-600 mb-6">Available on Android and iOS. Install the app to start receiving delivery requests.</p>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-earth-900 mb-4">How It Works</h2>
            <p className="text-earth-600 max-w-2xl mx-auto">Get started in 4 simple steps</p>
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="bg-white rounded-xl p-6 shadow-sm border border-earth-100">
                  ...
                  <h3 className="font-semibold text-earth-900 mb-2">{step.title}</h3>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 lg:p-12 text-center">
            ...
            <p className="text-primary-100 mb-8 max-w-2xl mx-auto">Download the app now and join hundreds of drivers earning with ZimAgritrust.</p>
            <button 
              onClick={() => setShowNotifyModal(true)}
          ...
          >
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-earth-900 mb-2">Driver App Coming Soon!</h2>
                <p className="text-earth-500">Be the first to know when our driver app launches.</p>
              </div>
              ...
              {!submitted ? (
                ...
                <div className="text-center py-4">
                  ...
                  <h3 className="text-lg font-semibold text-earth-900 mb-2">You're on the list!</h3>
                  <p className="text-earth-500 mb-6">We'll contact you as soon as the driver app is available.</p>
                  <button 
                    onClick={() => setShowNotifyModal(false)}
