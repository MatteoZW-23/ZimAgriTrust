    ...
    <div className="min-h-screen bg-earth-50">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Supplier Products</h1>
            <p className="text-xl text-green-100 mb-8">
              Browse quality agricultural inputs from verified suppliers
            </p>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{product.supplier_name || "Unknown"}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                    ...
                    {product.supplier_rating && (
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">⭐ {product.supplier_rating.toFixed(1)}</span>
                      </div>
                    )}
                  </div>
