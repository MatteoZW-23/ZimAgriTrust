    ...
    return (
      <div className="min-h-screen bg-earth-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/marketplace" className="text-green-600 hover:text-green-700 mt-4 inline-block">
            Back to Marketplace
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-medium">{product.supplier_rating?.toFixed(1) || "N/A"}</span>
                ...
                {product.supplier_verification === "approved" && (
                  <div className="flex items-center gap-1 px-3 py-1 bg-green-100 text-green-700 text-sm font-medium rounded-full">
                    <CheckCircle size={16} />
                    Verified
                  </div>
                )}
              ...
              <div className="space-y-3 mb-6">
                <button className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2">
                ...
                <button className="w-full border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2">
                  <Heart size={20} />
                  Add to Wishlist
                </button>
              </div>
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-6">{product.description || "Quality agricultural product from verified supplier."}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="font-medium">{product.product_type || "Standard"}</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-gray-600 mt-1">
                        <MapPin size={16} />
                        {supplier.location || "Zimbabwe"}
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1 px-3 py-1 bg-yellow-100 text-yellow-700 text-sm font-medium rounded-full">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    <div>
                      ...
                      <p className="font-medium">{supplier.total_products || "N/A"}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Orders</p>
                      <p className="font-medium">{supplier.total_orders || "N/A"}</p>
                    </div>
                    <div>
