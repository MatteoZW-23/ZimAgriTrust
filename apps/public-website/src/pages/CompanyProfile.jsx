      ...
      <section className="bg-gradient-to-r from-green-700 to-green-900 text-white pt-36 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-flex items-center rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 text-sm font-medium mb-6">
              Corporate Profile
            </span>

            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
              ZimAgriTrust Limited
            </h1>

            <p className="text-xl text-green-100 leading-relaxed max-w-3xl">
              Zimbabwe’s pioneer in digital agricultural trade, logistics,
              ...
              >
                ...
                <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
                  <p className="text-lg text-gray-600 leading-relaxed">
                    ZimAgriTrust Limited is a leading agricultural technology
              ...
              >
                ...
                <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Our escrow-powered transaction infrastructure ensures that
                    payments are only released upon successful verification and
                    delivery confirmation.
                  </p>

                  <div className="bg-green-50 border-l-4 border-green-700 rounded-r-2xl p-8">
                    <p className="text-2xl font-semibold italic text-green-900 leading-relaxed">
                      “Reducing agricultural trade risk by over 95% compared
            ...
            <aside className="space-y-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      AMA & ZAMACE Standards
                    </p>
                  </div>
                </div>

                <p className="text-gray-600 leading-relaxed">
                  We maintain compliance with recognized agricultural and
              ...
              <div className="bg-gradient-to-br from-green-700 to-green-900 rounded-3xl p-8 text-white">
                ...
                <p className="text-green-100 leading-relaxed mb-8">
                  Explore institutional partnerships and collaborative
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-10">
                Connect with our institutional partnerships team.
              </p>
              ...
              <div className="space-y-5">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      partnerships@zimagritrust.co.zw
                    </p>
                  </div>
                </a>
              </div>
              ...
              <div className="mt-10 pt-6 border-t border-gray-100 text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">
                  Partnership inquiries are usually answered within 24 hours.
                </p>
              </div>
            </motion.div>
          </motion.div>
