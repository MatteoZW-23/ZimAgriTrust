    ...
    <div className="min-h-screen bg-earth-50">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Verified Suppliers</h1>
            <p className="text-xl text-green-100 mb-8">
              Connect with trusted agricultural input suppliers across Zimbabwe
            </p>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{getBusinessTypeLabel(supplier.business_type)}</span>
                    </div>
                    {supplier.rating && (
                      <div className="flex items-center justify-between text-sm">
                    ...
                    {supplier.product_types && supplier.product_types.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2">
                        {supplier.product_types.slice(0, 3).map((type, idx) => (
                          <span
                            key={idx}
                        ...
                        {supplier.product_types.length > 3 && (
                          <span className="text-xs text-gray-500">
                            +{supplier.product_types.length - 3} more
                          </span>
                        )}
                      </div>
                    )}
