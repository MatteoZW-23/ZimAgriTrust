...
export default function SupportConcierge({ profile, onViewChange }) {
  ...
  const OPENROUTER_KEY = "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";
                ...
                <div className="msg-row bot">
                    <div className="msg-bubble shimmer" style={{ opacity: 0.7, padding: '14px 20px' }}>
                        <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                            ...
                            <div className="type-dot"></div>
                            <div className="type-dot"></div>
                            <span style={{ fontSize: '9px', fontWeight: 900, marginLeft: '8px', opacity: 0.5 }}>FETCHING UPDATES FROM HARARE...</span>
                        </div>
                    </div>
                </div>
            )}
