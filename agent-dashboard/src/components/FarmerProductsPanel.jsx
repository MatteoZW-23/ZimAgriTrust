    ...
    <div className="v4-dashboard-container animate-fade-in">
      ...
      <div className="v4-main-panel">
          <div className="v4-glass-card-premium">
              ...
              {products.length === 0 && (
                <div className="v4-empty-portfolio" style={{ padding: '100px 0', textAlign: 'center' }}>
                   <div style={{ fontSize: '64px', color: 'var(--v4-border)', marginBottom: '24px' }}><i className="fas fa-tractor"></i></div>
                   <h3 style={{ fontSize: '24px', fontWeight: 950, margin: '0 0 8px 0' }}>Initialize Your First Listing</h3>
                   <p style={{ color: 'var(--v4-text-dim)', fontWeight: 600, maxWidth: '400px', margin: '0 auto 32px auto' }}>Scale your reach by broadcasting your production to Zimbabwe's premier institutional buyers.</p>
                   <button className="q-btn primary-btn" onClick={() => setShowAddForm(true)} style={{ margin: '0 auto', background: '#000E2B' }}>Initialize Production Broadcast</button>
                </div>
              )}
          </div>
      </div>
