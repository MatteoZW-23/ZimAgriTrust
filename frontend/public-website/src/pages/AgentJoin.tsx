      ...
      <section className="bg-gradient-to-r from-green-700 to-green-900 text-white pt-36 pb-24">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-sm px-4 py-2 text-sm font-medium mb-6">
              <GraduationCap className="w-4 h-4" />
              Agent Academy
            </span>

            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
              Join the Agent Academy
            </h1>

            <p className="text-xl text-green-100 leading-relaxed max-w-3xl">
              Become a certified ZimAgriTrust Agent and support agricultural
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-14">
            ...
            <p className="text-lg text-gray-600">
              Agents bridge the gap between farmers, buyers, and logistics
              providers.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-14 text-center">
            ...
            <p className="text-lg text-gray-600">
              Follow these steps to become a certified field agent.
            </p>
          </div>
              ...
              {!submitted ? (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-10">
                    Complete the application form to begin your certification
                    journey.
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Years of Agriculture Experience
                        </label>
                        <input
                          type="number"
                          min={0}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <label htmlFor="hasSmartphone" className="text-gray-700">
                        I have a smartphone (required for the agent app)
                      </label>
                    </div>
                ...
                >
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto mb-6">
                    Thank you for applying to the Agent Academy. Our team will
                    review your application and contact you within 5 business
                    days.
                  </p>

                  {applicationId && (
                    <div className="bg-gray-50 rounded-2xl px-6 py-4 inline-block mb-10">
                      <div className="text-xs uppercase tracking-wider text-gray-500 mb-1">Application ID</div>
                      <code className="text-sm font-mono text-gray-800">{applicationId}</code>
                    </div>
                  )}
      ...
      <section className="pb-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-r from-green-700 to-green-900 rounded-3xl p-10 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-2xl p-6 flex items-center gap-5">
