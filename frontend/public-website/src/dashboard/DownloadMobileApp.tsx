    ...
    <div className="page">
      ...
      <main className="page-content">
          ...
          <div className="recruitment-grid">
            ...
            <div className="recruit-card driver-card">
              ...
              <div className="download-buttons">
                ...
                <button className="btn btn-outline" onClick={() => setShowNotifyModal(true)}>
        ...
        <div className="cta-section">
          <div className="cta-content">
            ...
            <button className="btn btn-primary btn-lg" onClick={() => setShowNotifyModal(true)}>
              <Bell size={20} />
      ...
      <footer className="simple-footer">
        <div className="footer-content">
          <p>© {new Date().getFullYear()} ZimAgritrust. All rights reserved.</p>
      ...
      {showNotifyModal && (
        <div className="modal-overlay" onClick={() => setShowNotifyModal(false)}>
          <div className="modal-box notify-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-brand">
              ...
              <h2>Coming Soon!</h2>
              <p>Our mobile apps are launching soon. Be the first to know.</p>
            </div>
            ...
            {!submitted ? (
              ...
              <div className="success-message">
                ...
                <button className="btn btn-outline btn-block" onClick={() => setShowNotifyModal(false)} style={{ marginTop: '1rem' }}>
                  Close
                </button>
              </div>
            )}
            ...
            <p className="notify-note">
              You can also use our web platform or dial <strong>*123#</strong> on any phone.
            </p>
          </div>
        </div>
      )}
