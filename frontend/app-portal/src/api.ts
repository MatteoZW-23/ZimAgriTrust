...
export const getMyRequests = () => request("/requests/me");
export const createBuyerRequest = (data) => request("/requests", { method: "POST", body: JSON.stringify(data) });
export const deleteBuyerRequest = (id) => request(`/requests/${id}`, { method: "DELETE" });
export const getAllRequests = () => request("/requests");
export const respondToRequest = (requestId, data) => request(`/requests/${requestId}/respond`, { method: "POST", body: JSON.stringify(data) });
export const acceptBidResponse = (responseId) => request(`/requests/responses/${responseId}/accept`, { method: "POST" });
