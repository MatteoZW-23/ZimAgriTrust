...
PRESETS = [
    ("Check Market Prices", "1"),
    ("List Produce for Sale", "2"),
    ("Manage My Listings", "3"),
    ("Escrow & Payments", "4"),
    ("Sell Grade A Maize", "2*Maize*15.5*A*Goromonzi"),
]
...
def index():
    ...
    phone_number = request.form.get("phone_number") or session.get("phone_number") or "+263771234567"
