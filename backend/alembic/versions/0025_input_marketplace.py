...
def upgrade() -> None:
    for e in (
        input_listing_status_enum, input_offer_status_enum, input_order_status_enum,
        input_report_reason_enum, input_report_status_enum,
    ):
    ...
    op.create_table(
        ...
        sa.Column("status", input_listing_status_enum, nullable=False, server_default="pending_verification"),
    ...
    op.create_table(
        ...
        sa.Column("status", input_offer_status_enum, nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(5), server_default="USD"),
        sa.Column("status", input_order_status_enum, nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("reason", input_report_reason_enum, nullable=False),
        sa.Column("details", sa.Text(), nullable=True),
        sa.Column("evidence_urls", postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column("status", input_report_status_enum, nullable=False, server_default="open"),
