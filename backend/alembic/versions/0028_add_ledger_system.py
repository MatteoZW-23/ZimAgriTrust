...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('account_type', sa.Enum('CASH_USD', 'CASH_ZIG', 'PENDING_ESCROW_USD', 'PENDING_ESCROW_ZIG', 'RECEIVABLES', 'USER_BALANCE_USD', 'USER_BALANCE_ZIG', 'PAYABLES', 'PLATFORM_FEE_USD', 'PLATFORM_FEE_ZIG', 'TRANSPORT_FEE_USD', 'INSURANCE_FEE_USD', 'PROVIDER_PAYOUT_USD', 'PROVIDER_PAYOUT_ZIG', 'REFUND_USD', 'REFUND_ZIG', name='ledgeraccounttype'), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column('id', postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text('gen_random_uuid()')),
        sa.Column('account_type', sa.Enum('CASH_USD', 'CASH_ZIG', 'PENDING_ESCROW_USD', 'PENDING_ESCROW_ZIG', 'RECEIVABLES', 'USER_BALANCE_USD', 'USER_BALANCE_ZIG', 'PAYABLES', 'PLATFORM_FEE_USD', 'PLATFORM_FEE_ZIG', 'TRANSPORT_FEE_USD', 'INSURANCE_FEE_USD', 'PROVIDER_PAYOUT_USD', 'PROVIDER_PAYOUT_ZIG', 'REFUND_USD', 'REFUND_ZIG', name='ledgeraccounttype'), nullable=True),
