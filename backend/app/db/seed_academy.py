    ...
    modules = [
        {
            ...
            "passing_score": 80.0,
            "topics": [
                {"id": "1.1", "title": "Welcome to AgriTrust", "pages": 5, "content": "Welcome to AgriTrust. Our mission is to eliminate the trust deficit in rural agricultural markets. Farmers lack access to fair markets due to unreliable yield verification. AgriTrust provides sovereign identity, verifiable proof through field agents, and smart escrow for secure payments." },
                {"id": "1.2", "title": "System Architecture Overview", "pages": 8, "content": "System Architecture: AgriTrust uses multi-layered infrastructure for low-connectivity environments. Core backend handles ledger and escrow. Agent portal for mobile field use. Farmer interface via USSD and WhatsApp. IoT gateway for warehouse sensors. AI models analyze crop photos." },
            ...
            "quiz_questions": {
                "questions": [
                    ...
                    {"id": "q1_8", "text": "What is the first step of an AgriTrust trade?", "options": ["Payment", "Listing", "Verification", "Grading"], "correct_index": 1},
        ...
        },
        {
            ...
            "quiz_questions": {
                "questions": [
                    ...
                    {"id": "q2_6", "text": "What is the standard AgriTrust platform fee percentage?", "options": ["1%", "2.5%", "5%", "10%"], "correct_index": 1},
        ...
        },
        {
            ...
            "topics": [
                ...
                {"id": "5.3", "title": "Career Progression Levels", "pages": 10, "content": "Career progression levels: AgriTrust is career path not just gig. Levels: field trainee with supervised verification, certified agent with independent verification rights, senior agent handling high-value listings over $10k and MFI loan verification, lead auditor investigating disputes from other agents. Each level unlocked increases base commission percentage."}
            ],
            "quiz_questions": {
                "questions": [
        ...
        },
        {
            ...
            "quiz_questions": {
                "questions": [
                    ...
                    {"id": "q6_4", "text": "What is 'poaching' in the AgriTrust context?", "options": ["Hunting wildlife on farms", "Encouraging farmers to trade off-platform to avoid fees", "Stealing crops", "Taking competitor agents"], "correct_index": 1},
        ...
        },
        {
            ...
            "topics": [
                ...
                {"id": "7.2", "title": "Credit Scoring for Smallholders", "pages": 15, "content": "Credit scoring for smallholders: Traditional banks use pay slips, AgriTrust uses ledger history. Data points: yield growth check if farmer produces more each year, repayment rate check if they fulfill trade commitments, quality consistency check if maize always grade A. Providing this data enables farmers to buy tractors and better seeds."},
            ...
            "quiz_questions": {
                "questions": [
                    ...
                    {"id": "q7_3", "text": "Which data point is NOT used in AgriTrust's Sovereign Credit Scoring?", "options": ["Yield Growth", "Repayment Rate", "Quality Consistency", "Farmer's Political Affiliation"], "correct_index": 3},
        ...
        },
        {
            ...
            "quiz_questions": {
                "questions": [
                    {"id": "q8_1", "text": "What is a 'Binding Contract' in AgriTrust?", "options": ["A friendly promise", "A legal agreement enforceable by law once signed digitally via the platform", "An email", "A handshake"], "correct_index": 1},
        ...
        },
        {
            ...
            "topics": [
                ...
                {"id": "9.3", "title": "Blockchain & Immutability", "pages": 15, "content": "Blockchain and immutability: AgriTrust uses distributed ledger not central database. Immutability matters: no deletions once signed report cannot be deleted or altered, audit trail records every change with timestamp and ID, buyer confidence international buyers trust data as mathematically impossible to forge. Remember: your ID is reputation, false report stays on ledger forever."}
            ],
            "quiz_questions": {
                "questions": [
                    ...
                    {"id": "q9_4", "text": "Why does AgriTrust use a Distributed Ledger instead of a central database?", "options": ["It is cheaper", "It ensures immutability and prevents tampering with transaction records", "It is faster", "It uses less storage"], "correct_index": 1},
                    ...
                    {"id": "q9_8", "text": "What type of satellite imagery does AgriTrust use to verify farm size?", "options": ["Google Street View", "Sentinel-2 Satellite Imagery", "NASA Apollo photos", "Weather radar"], "correct_index": 1},
        ...
        },
        {
            ...
            "passing_score": 90.0,
            "topics": [
                {"id": "10.1", "title": "The Golden Service Rule", "pages": 10, "content": "Golden service rule: As AgriTrust agent you are consultant not bureaucrat. Etiquette: always greet farmer and village elders respectfully, show moisture meter reading to farmer for transparency, arrive on time as farmer's time is valuable. Goal: every farmer should want you back for next harvest."},
